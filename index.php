...
switch ($act) {
    case '404':
        ...
        -----------------------------------------------------------------
        */
        echo '<tr><td colspan="2">'.functions::display_error($lng['error_404']).'</td></tr>';
        break;
    ...
    case 'digest':
        ...
        */
        ...
        // Дайджест Администратора - Digest Administrator
        if ($rights >= 1) {
    ...
    default:
        /*
        -----------------------------------------------------------------
        Главное меню сайта - The main menu of the website <I think this location is the content main>
        -----------------------------------------------------------------
        */
        if (isset($_SESSION['ref']))
            unset($_SESSION['ref']);
