...
<script>
    ...
    $(function() {
        ...
        $('#fileupload').fileupload({
            ...
            url: '<?php echo $this->Html->url(array('action' => 'upload')) ?>'
        });
...
<div class="container">
    ...
    <form id="fileupload" action="<?php echo $this->Html->url(array('action' => 'upload')) ?>" method="POST" enctype="multipart/form-data">
